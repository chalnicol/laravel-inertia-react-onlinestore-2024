...
export default function VariantInput ({ variant, index, errors = {}, onValueChange, onRemove }) {
    ...
    return (
        ...
        <div className="rounded overflow-hidden border border-gray-400 bg-white">
            <div className="flex justify-between items-center px-3 py-2 bg-gray-200 text-gray-500">
                <h3 className="text-sm font-medium">Product Variant {index + 1} </h3>
                ...
                <div className="grid grid-cols-2 grid-rows-2 gap-x-2">
                    <div className="mb-2">
                        <input 
                            ...
                            className={`border rounded w-full py-1.5 px-2 text-sm ${ errors.variant_name ? 'border-red-500' : 'border-gray-500'}`}
                    ...
                    <div className="mb-2">
                        <input 
                            ...
                            className={`border rounded w-full py-1.5 px-2 text-sm ${ errors.variant_quantity ? 'border-red-500' : 'border-gray-500'}`}
                    ...
                    <div className="mb-2">
                        <input 
                            ...
                            className={`border rounded w-full py-1.5 px-2 text-sm ${ errors?.variant_cost_price ? 'border-red-500' : 'border-gray-500'}`}
                    ...
                    <div className="mb-2">
                        <input 
                            ...
                            className={`border rounded w-full py-1.5 px-2 text-sm ${ errors.variant_base_price ? 'border-red-500' : 'border-gray-500'}`}
