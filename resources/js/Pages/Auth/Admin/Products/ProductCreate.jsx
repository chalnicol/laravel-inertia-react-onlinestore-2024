                    ...
                    <div className="lg:grid grid-cols-2 gap-x-6">
                        ...
                        <div>
                            ...
                            <div className="mb-4">
                                ...
                                <SelectSearch className={`${ errors.brand_id ? 'border-red-500' : 'border-gray-500'}`} resource="brands" multiSelect={false} onValueChange={handleBrandChange}/>
                                {errors.brand_id && <div className="text-red-500 text-xs">{errors.brand_id}</div>}

                            </div>
                            
                            <div className="mb-4">
                                <SelectSearch className={`${ errors.category_id ? 'border-red-500' : 'border-gray-500'}`} resource="categories" multiSelect={false} onValueChange={handleCategoryChange}/>
